...
let combinedFilePath = "combined.iOS.tmp.txt"
...
let outputFileName = "iOSLocalization.apple"
...
func createLocalizations() {
	...
	twineTask.arguments = ["exec", "twine", "generate-all-localization-files", combinedFilePath, outputDirectory, "--format", "apple", "--file-name", outputFileName, "--create-folders"]
	twineTask.launch()
